...
const App = () => (
  <BrowserRouter>
    ...
    {/* <img src={background} className="w-full h-auto object-cover absolute"></img> */}
    <main className="sm:p-8 px-4 py-8 w-full bg-[#f9fafe] min-h-[calc(100vh-73px)] z-1 bg-[url('./assets/background.jpg')]">
      <Routes>
