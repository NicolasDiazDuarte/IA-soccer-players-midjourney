  ...
  <div className="rounded-xl group relative shadow-card h">
    ...
    <div className=" w-72  border-2 border-black flex-col object-cover max-h-[94.5%] bottom-0 left-0 right-0  bg-gradient-to-r from-[#e1d5e6] to-neutral-100 p-2 rounded-b-md">
      ...
      <div className="flex items-center">
        <p className="text-black text-2xl font-extrabold">{name}</p>
        <div className=" text-white border-2  bg-black rounded-full ml-auto text-2xl font-extrabold right-0 top-0">
      ...
      <p className="flex justify-center mt-2 text-white text-2xl rounded-full border-2 bg-black font-extrabold m-auto prompt">
        {version}
      </p>
    </div>
  </div>
